...
public class Advent15 {
    public static void main(String[] args) {
        ...
        try {
            ...
            Map<Coordinate, Integer> phase2Map = possiblePoints(sensorBeacons, phase2boundry);
            for (Coordinate p : phase2Map.entrySet().stream().sorted(Collections.reverseOrder(Map.Entry.comparingByValue())).
    ...
    private static @NotNull Map<Coordinate, Integer> possiblePoints(@NotNull ArrayList<SensorBeacon> sensorBeacons, int boundry) {
